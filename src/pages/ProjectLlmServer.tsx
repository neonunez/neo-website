...
const techStack = [
  "llama.cpp", "Qwen3-8B", "Nginx", "Cloudflare", "NSSM", "PowerShell", "Vulkan", "Python", "Windows",
];
...
const GITHUB_URL = "https://github.com/neonunez/llm-server";
...
export default function ProjectLlmServer() {
  ...
  const navLabels: Record<string, string> = {
    "intro":        "LLM Server",
    "problem":      tr.llmSrvLabel_problem,
    "insight":      tr.llmSrvLabel_insight,
    "how-it-works": tr.llmSrvLabel_howItWorks,
    "architecture": tr.llmSrvLabel_architecture,
    "tech-stack":   tr.llmSrvLabel_techStack,
    "outcomes":     tr.llmSrvLabel_outcomes,
    "learnings":    tr.llmSrvLabel_learnings,
  };
      ...
      <div className="py-6">
            ...
            <div className="flex items-start justify-between gap-5 flex-wrap">
              <div className="flex-1 min-w-0">
                <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[var(--c-muted)] mb-3">
                  {tr.llmSrvTldr_heading}
                </p>
                <ul className="space-y-2">
                  {[tr.llmSrvTldr_b1, tr.llmSrvTldr_b2, tr.llmSrvTldr_b3].map((item, i) => (
        ...
        <div id="problem">
          <ContentBlock delay={0.08}>
            <SectionLabel>{tr.llmSrvLabel_problem}</SectionLabel>
            <div className="space-y-3 text-sm leading-[1.85] text-[var(--c-soft)] border-l border-[var(--c-border)] pl-4">
              <p>{tr.llmSrvProblem_p1}</p>
              <p>{tr.llmSrvProblem_p2}</p>
              <p>{tr.llmSrvProblem_p3}</p>
            </div>
          </ContentBlock>
        </div>
        ...
        <div id="insight">
          <ContentBlock delay={0.12}>
            <SectionLabel>{tr.llmSrvLabel_insight}</SectionLabel>
            <div className="space-y-3 text-sm leading-[1.85] text-[var(--c-soft)] border-l border-[var(--c-border)] pl-4">
              <p>{tr.llmSrvInsight_p1}</p>
              <p>{tr.llmSrvInsight_p2}</p>
              <p>{tr.llmSrvInsight_p3}</p>
            </div>
          </ContentBlock>
        </div>
        ...
        <div id="how-it-works">
          <ContentBlock delay={0.16}>
            ...
            <div className="space-y-3 text-sm leading-[1.85] text-[var(--c-soft)] border-l border-[var(--c-border)] pl-4">
              ...
              <p>
                {tr.llmSrvHowItWorks_p2a}
                <code className="text-xs font-mono bg-[var(--c-surface)] px-1.5 py-0.5 rounded text-[var(--c-muted)]">/no_think</code>
                {tr.llmSrvHowItWorks_p2b}
              </p>
              <p>{tr.llmSrvHowItWorks_p3}</p>
            </div>
          </ContentBlock>
        </div>
        ...
        <div id="architecture">
          <ContentBlock delay={0.20}>
            <SectionLabel>{tr.llmSrvLabel_architecture}</SectionLabel>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <ArchCard icon={<Workflow size={14} />} title={tr.llmSrvArch_1_title} description={tr.llmSrvArch_1_desc} />
              <ArchCard icon={<Shield size={14} />}   title={tr.llmSrvArch_2_title} description={tr.llmSrvArch_2_desc} />
              <ArchCard icon={<Cpu size={14} />}      title={tr.llmSrvArch_3_title} description={tr.llmSrvArch_3_desc} />
              <ArchCard icon={<Server size={14} />}   title={tr.llmSrvArch_4_title} description={tr.llmSrvArch_4_desc} />
            </div>
          </ContentBlock>
        </div>
        ...
        <div id="tech-stack">
          <ContentBlock delay={0.24}>
            <SectionLabel>{tr.llmSrvLabel_techStack}</SectionLabel>
            <div className="py-10">
              <TechMarquee />
            </div>
          </ContentBlock>
        ...
        <div id="outcomes">
          <ContentBlock delay={0.28}>
            <SectionLabel>{tr.llmSrvLabel_outcomes}</SectionLabel>
            <OutcomesList items={[
              tr.llmSrvOutcome_1,
              tr.llmSrvOutcome_2,
              tr.llmSrvOutcome_3,
        ...
        <div id="learnings">
          <ContentBlock delay={0.32}>
            <SectionLabel>{tr.llmSrvLabel_learnings}</SectionLabel>
            <div className="space-y-3 text-sm leading-[1.85] text-[var(--c-soft)] border-l border-[var(--c-border)] pl-4">
              <p>{tr.llmSrvLearnings_p1}</p>
              <p>{tr.llmSrvLearnings_p2}</p>
              <p>{tr.llmSrvLearnings_p3}</p>
              <p>{tr.llmSrvLearnings_p4}</p>
            </div>
          </ContentBlock>
        </div>
