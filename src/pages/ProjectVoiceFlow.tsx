...
const techStack = ["Python", "mlx-whisper", "pyobjc", "rumps", "pywebview"];
        ...
        <FadeUp delay={0.04}>
          <div className="mb-10">
            ...
            <p className="text-[var(--c-muted)] text-sm leading-relaxed">
              macOS menu bar speech-to-text app. A self-hosted alternative to Wispr Flow running local models via MLX. Detailed project description coming soon...
            </p>
          </div>
        </FadeUp>
