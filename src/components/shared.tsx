...
export function Badge({ icon, children }: { icon: React.ReactNode; children: React.ReactNode }) {
  return (
    <span className="inline-flex items-center gap-1.5 px-2 py-1 text-[13px] rounded-md border border-[var(--c-border-strong)] bg-[var(--c-surface)] text-[var(--c-fg)] align-middle leading-none font-medium whitespace-nowrap hover:bg-[var(--c-surface-2)] hover:scale-[1.04] transition-all duration-300 ease-out z-10 hover:z-20">
